...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.localEulerAngles = currentCube.localEulerAngles;
    ...
    void FollowPath()
    {
        ...
        for (int i = finalPath.Count - 1; i > 0; i--)
        {
            ...
            //s.Join(transform.DOLookAt(finalPath[i].position, .1f));
            //Debug.Log(finalPath[i].position);
            //transform.LookAt(finalPath[i].position + finalPath[i].up);
        }
